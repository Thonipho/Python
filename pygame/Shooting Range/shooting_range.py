...
#setting of screen and its modifications
pygame.init()
...
#positioning and allocation of attributes
...
#creating list to store ducks and their positioning
duck_list = []
...
#loop that controls the continious functioning of the game
while True:
	#events that are triggered by user inputs
	...
	#spawning and conditioning of attributes
